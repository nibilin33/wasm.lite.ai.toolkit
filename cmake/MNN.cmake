...
if (NOT EXISTS ${MNN_DIR})
    ...
    # set(MNN_Filename "MNN-${MNN_Version}-macos-x86_64.tgz")
...
set(MNN_INCLUDE_DIRS ${MNN_DIR}/include)
set(MNN_LIBRARIES ${MNN_DIR}/lib/libMNN.a)
# set(MNN_LIBRARIES ${MNN_DIR}/lib/libMNN.dylib)
...
set(INSTALL_PATH ${CMAKE_BINARY_DIR}/include/lite/mnn)
file(INSTALL ${MNN_CORE_HEAD} DESTINATION ${INSTALL_PATH}/core)
file(INSTALL ${MNN_CV_HEAD} DESTINATION ${INSTALL_PATH}/cv)
file(INSTALL ${MNN_ASR_HEAD} DESTINATION ${INSTALL_PATH}/asr)
file(INSTALL ${MNN_NLP_HEAD} DESTINATION ${INSTALL_PATH}/nlp)